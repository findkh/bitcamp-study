...
public class Sender {
  ...
  public static void main(String[] args) throws Exception {
    ...
    //new Socket(원격 호스트의 IP주소/도메인 이름, 원격 호스트의 포트번호)
    //      - 로컬호스트(애플리케이션을 실행하는 현재 컴퓨터)일 경우 : 127.0.0.1 또는 localhost
    Socket socket = new Socket("192.168.0.173", 8888); //서버의 대기열에 등록된다면 리턴한다. 
