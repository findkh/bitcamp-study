...
public class Exam3 {
  ...
  @GetMapping("/test3")
  public String test3() {
    return "정수: " + 21_4748_3648L; //OK 리터럴을 저장할 떄 8바이트 메모리를 사용하라고 표시한다
  } 

  @GetMapping("/test4")
  public String test4() {
    return "정수: " + -21_4748_3649l; //OK 리터럴을 저장할 떄 8바이트 메모리를 사용하라고 표시한다
  } 

  @GetMapping("/test5")
  public String test5() {
    return "정수: " + 922_0000_0000_0000_0000L; //OK 리터럴을 저장할 떄 8바이트 메모리를 사용하라고 표시한다
  } 
