...
public class LinkedList {
  ...
  // 특정 클래스 안에서만 사용 되는 클래스 일 때 바깥 클래스의 인스턴스 멤버를 사용하지 않을 때
  // 중첩 클래스로 만듦. Node는 LinkedList에서만 사용되기 때문에 private.
  // 바깥 필드를 사용하지 않기 때문에 static으로 만듦.
