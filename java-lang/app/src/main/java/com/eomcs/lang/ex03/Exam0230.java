...
public class Exam0230 {
  public static void main(String[] args) {
    ...
    System.out.println("4바이트로 표현할 수 있는 최대값: "+Integer.MAX_VALUE); 
    // 4바이트로 표현할 수 있는 정수 최대값
    System.out.println("4바이트로 표현할 수 있는 최소값: " + Integer.MIN_VALUE); 
    // 4바이트로 표현할 수 있는 정수 최소값
    System.out.println("8바이트로 표현할 수 있는 정수 최대값: " + Long.MAX_VALUE); 
    // 8바이트로 표현할 수 있는 정수 최대값 
    System.out.println("8바이트로 표현할 수 있는 정수 최소값: " + Long.MIN_VALUE); 
    // 8바이트로 표현할 수 있는 정수 최소값
