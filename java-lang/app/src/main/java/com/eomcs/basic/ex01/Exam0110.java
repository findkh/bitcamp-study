...
public class Exam0110 /*extends Object*/ {
  ...
  public static void main(String[] args) {
    ...
    Object obj = new My(); //다형적 변수의 특징 상위 분류는 하위 분류를 가리킬 수 있다.
    ...
    System.out.println(obj.toString()); //인스턴스에 대한 정보 @앞은 클래스 정보 @ 뒤는 인스턴스의 식별번호
...
//    => 같은 인스턴스인지 검사한다. 
// 3) hashCode()
//    => 인스턴스를 식별하는 값을 리턴한다. 해시 코드의 주소 값이 아니다.
// 4) getClass()
//    => 인스턴스의 클래스 정보를 리턴한다.
// 5) clone()
