...
public class BoardController {
  ...
  public BoardController() {
    ...
    try {
      ...
      //System.out.println(jsonStr); -> 제대로 읽었는지 콘솔창에서 확인
      ...
      //  System.out.println(board.getClass()); //클래스 정보 확인
      //  System.out.println(board); //board 객체의 toString 값 확인
      //}

      //3. 배열 객체를 ArrayList에 저장한다.
      // -> 다음과 같이 배열에서 한 개 씩 목록에 추가할 수 있다.
      //for (Board board : boards) {
      //boardList.add(board);
      //}
      // -> addAll() 메서드 만든 후 호출하여 배열 목록에 추가할 수 있다.
      //boardList.addAll(boards);

      // -> 다음과 같이 생성자를 통해 배열 목록을 추가할 수 있다.
  ...
  public Object save() throws Exception {
    ...
    //System.out.println(jsonStr); -> save 되는지 확인해봄(콘솔창에서)
    out.println(jsonStr);
