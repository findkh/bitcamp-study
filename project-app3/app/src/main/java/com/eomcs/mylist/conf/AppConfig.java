...
//Spring 프레임 워크의 설정 정보를 담은 클래스
//

//1. Spring IoC 컨테이너에게 객체를 생성하기 위한 패키지를 알려준다.
// -> 스프링 IoC 컨테이너는 패키지를 뒤져서 @Component, @Controller, @Service 등이 
//    붙은 클래스를 찾아내어 객체를 생성한 후 보관한다.
@ComponentScan("com.eomcs.mylist") 

//2. DB 관련 설정할 때 DBMS 정보를 담은 properties 파일을 로딩한다.
